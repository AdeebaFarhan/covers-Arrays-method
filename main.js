...
//Slice
// example : 01
var items = ["pencile", "paper", "eraser", "scale"];
var subset = items.slice(1, 3);
console.log(subset);
console.log(items);
//example : 02
...
//console.log(newArr);
//example: 03
var number = [2, 5, 0, 6, 2, 0, 0, 4];
var newArr = number.slice(2, 7);
console.log(newArr);
//Splice
//let gases: string[]=["Hydrogen","Oxeygen","Carbondioxide","Nitrogen"]
...
var myRoutine = ["Morning", "Afternoon", "Evening", "Night"];
